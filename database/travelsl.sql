...
(1, ' Adventure in SriLanka    ', 1, 1, 20000, '24.jpg', '26.jpg', '25.jpg', 'Sri Lanka, often called the "Pearl of the Indian Ocean," is a tropical paradise renowned for its stunning landscapes, rich history, and vibrant culture. From golden beaches and lush tea plantations to ancient UNESCO World Heritage Sites like Sigiriya and the Temple of the Tooth Relic in Kandy, the island offers something for every traveler. It’s a haven for wildlife enthusiasts, with safaris in Yala National Park and whale watching in Mirissa. Adventure seekers can hike in Ella or surf along the southern coast, while food lovers can indulge in flavorful Sri Lankan cuisine. With its warm hospitality and year-round tropical climate, Sri Lanka is an unforgettable destination.'),
