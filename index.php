...
<div class="about section" id="section-2">
    ...
    <div class="container">
        <div class="col-md-4 about-grids">
            <h4>Our Vision</h4>
            <p>Pain itself is love, the main architect of pain, but at times it occurs in which toil and pain may bring some great pleasure. For example, some people, by pursuing pleasure, avoid certain obligations or endure pain for its benefits. However, these pains may result in unseemly consequences if one doesn't exercise reason and discernment. Thus, any such labor or discomfort is excused as an escape from accusations or harsh consequences of the harsh realities of the soul.</p>
        </div>
        <div class="col-md-4 about-grids grid2">
            <h4>Our Mission</h4>
            <p>True fulfillment often arises from overcoming challenges and enduring hardships, as they pave the way for greater satisfaction. Many seek pleasure and comfort, yet sometimes the pursuit of these goals requires effort and sacrifice. However, without careful thought, this pursuit may lead to unintended consequences. In such cases, the hardships faced are often justified as necessary steps to avoid greater struggles or discomforts, offering a reprieve from more significant burdens.</p>
        </div>
        <div class="col-md-4 about-grids">
            <h4>Safety Information</h4>
            <p>Safety, like the pursuit of comfort, often requires effort and the willingness to endure certain challenges. Just as pain can lead to growth, adhering to safety protocols might sometimes feel inconvenient, but it ensures greater protection in the long run. While it may seem tempting to bypass certain precautions for immediate ease, doing so can lead to serious consequences. By making safety a priority, we avoid potential risks and ensure a secure environment for everyone involved. In this way, safety is not just a set of rules, but a conscious decision to protect ourselves and others from harm..</p>
        </div>
    </div>
    <!--top-tours-->
